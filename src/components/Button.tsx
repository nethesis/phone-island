...
export const Button: FC<ButtonProps> = ({
  ...
  const classes = {
    ...
    variant: {
      red: 'dark:pi-bg-red-600 pi-bg-red-700 enabled:hover:pi-bg-red-700 focus:pi-ring-red-500',
      ...
      transparent:
        'pi-bg-transparent dark:enabled:hover:pi-bg-gray-500 enabled:hover:pi-bg-gray-400 focus:pi-ring-offset-gray-200 dark:focus:pi-ring-gray-500 dark:focus:pi-ring-gray-500 focus:pi-ring-gray-400',
    },
    background: {
      base: {
