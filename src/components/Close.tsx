      ...
      {(view === 'player' || view === 'recorder') && (
        <div className='pi-flex pi-justify-center'>
          <div
            ...
            className='pi-h-9 pi-w-9 pi-rounded-full dark:pi-bg-gray-950 pi-bg-gray-50 hover:pi-bg-gray-500 pi-flex pi-items-center pi-justify-center dark:pi-text-white pi-text-gray-900 pi-mt-4 pi-pointer-events-auto pi-cursor-pointer pi-transition-colors'
          >
